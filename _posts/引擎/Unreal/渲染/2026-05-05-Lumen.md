...
> 本文基于 UE5 源码（`Engine/Source/Runtime/Renderer/Private/Lumen/*` 与 `Engine/Source/Runtime/Engine/Public/MeshCardRepresentation.h`）整理，汇总 Lumen 的数据结构、离线构建、场景更新、光照流程全链路。逐函数笔记见同目录 `Base/`、`Build/`、`SceneUpdate/`、`Lighting/` 子目录。
