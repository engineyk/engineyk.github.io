...
![alt text](渲染管线/三角形设置.png)
![alt text](渲染管线/三角形设置_插值.png)
...
Early-z渲染时机![alt text](渲染管线/Early-z渲染时机.png)
